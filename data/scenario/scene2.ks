...
[bg  storage="extra.webp"  time="1000"  method="slideInDown"  ]
[tb_start_tyrano_code]
;文字初期化（ステージが替わるとき）
[iscript]
f.a11 = 0;
...
// --- WiFi設置回数を決定 ---
let times = 7;
// stage1→5回, stage15→19回, stage20→24回...

// --- WiFi候補マス（対応表） ---
const wifiMap = {
1:"w11", 2:"w12", 3:"w13", 4:"w14", 5:"w15", 6:"w16", 7:"w17",
8:"w21", 9:"w22", 10:"w23", 11:"w24",
12:"w25", 13:"w26", 14:"w27",
15:"w31", 16:"w32", 17:"w33", 18:"w34", 19:"w35", 20:"w36", 21:"w37",
22:"w41", 23:"w42", 24:"w43", 25:"w44", 27:"w46",
...
[tb_start_tyrano_code]
[eval exp="f.a37 = f.a37 + 100"]
[eval exp="f.a46 = f.a46 + 100"]
[eval exp="f.a57 = f.a57 + 100"]
[eval exp="f.a36 = f.a36 + 100"]
[eval exp="f.a56 = f.a56 + 100"]
[_tb_end_tyrano_code]
...
[jump  storage="scene2.ks"  target="*answer"  cond="f.p==47"  ]
[jump  storage="scene2.ks"  target="*answer"  cond="f.over==1"  ]
[clickable  storage="scene2.ks"  x="437"  y="759"  width="92"  height="90"  target="*up"  _clickable_img=""  ]
[clickable  storage="scene2.ks"  x="336"  y="859"  width="92"  height="90"  target="*left"  _clickable_img=""  ]
[clickable  storage="scene2.ks"  x="435"  y="859"  width="92"  height="90"  target="*down"  _clickable_img=""  ]
[clickable  storage="scene2.ks"  x="537"  y="860"  width="92"  height="90"  target="*right"  _clickable_img=""  ]
[s  ]
*up
...
[jump  storage="scene2.ks"  target="*move"  ]
*left
...
[tb_start_tyrano_code]
[if exp="f.over == 0"]
[ptext layer="2" text="!!" x="560" y="370" size="80" color="yellow" bold="bold" edge="black"]
[endif]
[_tb_end_tyrano_code]

[l  ]
[jump  storage="prologue3.ks"  target=""  cond="f.over==0"  ]
*gameover
...
[glink  color="btn_25_yellow"  storage="scene2.ks"  size="28"  x="328"  y="439"  width="255"  height="67"  text="再挑戦する"  _clickable_img=""  autopos="false"  target="*origin"  ]
[s  ]
